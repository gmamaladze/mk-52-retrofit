# -*- coding: utf-8 -*-
# ПЗУ (ROM) tables ported verbatim from emulator/emulator.js (ПЗУ.ИК1302 / ПЗУ.ИК1303).
# МК-52 mode (расширенный=False) uses ИК1302 and ИК1303 only; ИК1306 is omitted.
